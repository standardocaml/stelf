...
include CsEqField_intf
(* signature CS_EQ_FIELD *)

(* # 1 "src/solvers/CsEqField.fun.ml" *)
open! Basis
...
module CsEqField (CSEqField__0 : sig
  ...
  module Unify : UNIFY
end) : CS_EQ_FIELD with type Field.number = CSEqField__0.Field.number = struct
  (*! structure CsManager = CsManager !*)
  module Field = CSEqField__0.Field
  module Unify = CSEqField__0.Unify
  ...
  *)
  ...
  (* CsManager.ModeSyn *)
  (* FgnExp representation for this domain *)
...
(* # 1 "src/solvers/CsEqField.sml.ml" *)
